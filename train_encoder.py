...
model_folder = os.path.join("models", "encoder")
...
train_sentences = [train_data[i]["translation"][0] for i in range(len(train_data))]
val_sentences = [val_data[i]["translation"][0] for i in range(len(val_data))]
test_sentences = [test_data[i]["translation"][0] for i in range(len(test_data))]
